...
device_info_moreInfo    = ("xpath", "//*[@id='about']/div/ul[1]/li[5]/label/button")
device_moreInfo_header    = ("xpath", "//*[@id='about-moreInfo']/header/h1")
device_moreInfo_developer = ("xpath", "//*[@id='about-moreInfo']/div/ul[3]/li/label/button")
device_developer_header = ("xpath", "//*[@id='about-moreInfo-developer']/header/h1")
device_developer_FTU    = ("id", "ftuLauncher")
