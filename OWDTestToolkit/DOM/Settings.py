...
call_settings_header = ('css selector', 'h1[data-l10n-id=callSettings-header]')
call_callerID = ('id', "menuItem-callerId")
call_fdn = ('id', 'fdn-enabled')
...
fdn_settings_header = ('css selector', 'h1[data-l10n-id=fdnSettings-header]')
fdn_settings_menu = ('css selector', 'a[data-href="#call-fdnSettings"]')
fdn_auth_numbers = ('css selector', '[data-l10n-id=fdn-authorizedNumbers]')
fdn_pin2_header = ('css selector', 'h1[data-l10n-id=pin2Title]')
fdn_pin2_input = ('css selector', '#call-pin2-dialog .sim-code-area.sim-pinArea input')
fdn_pin2_done = ('css selector', 'section#call-pin2-dialog button[data-l10n-id=done]')
...
cell_data_advanced_apn_settings = ('css selector', 'section#carrier button[data-l10n-id=apnSettings]')

networkOperator_button = ('css selector', '#carrier-detail button[data-l10n-id=networkOperator]')
network_operator_advanced_button = ('css selector', 'div.carrier-advancedSettings button[data-l10n-id=networkOperator]')
networkOperator_header = ('css selector', '#carrier-operatorSettings gaia-header h1')
networkOperator_types = ("id", "preferredNetworkType")
networkOperator_select_type = ("xpath", u"//section[@class='value-selector-container']//span[text()='{}']")
...
sim_security_enter_pin_header = ('css selector', 'h1[data-l10n-id=pinTitle]')
...
lockscreen_label = ('css selector', 'span[data-l10n-id=lockScreen]')
...
change_pin_done_btn = ('css selector', 'section#simpin-dialog button[data-l10n-id=done]')
