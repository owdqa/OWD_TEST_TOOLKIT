...
service_worker_header = ('css selector', 'div[data-scope="{}"] h2')
service_worker_scope = ('css selector', 'li span[data-l10n-id=service-worker-scope]')
service_worker_script_spec = ('css selector', 'li span[data-l10n-id=service-worker-script-spec]')
service_worker_current_url = ('css selector', 'li span[data-l10n-id=service-worker-current-worker-url]')
service_worker_active_cache_name = ('css selector', 'li span[data-l10n-id=service-worker-active-cache-name]')
service_worker_waiting_cache_name = ('css selector', 'li span[data-l10n-id=service-worker-waiting-cache-name]')
