...
CP_Cancel_Message = ("css selector", 'form#cp-quit-app-confirm strong[data-l10n-id="cp-quit-app-confirm-dialog-message"]')
CP_Quit_Button = ("css selector", 'form#cp-quit-app-confirm button[data-l10n-id="quit"]')
CP_Confirm_Cancel = ("css selector", 'form#cp-quit-app-confirm button[data-l10n-id="cancel"]')