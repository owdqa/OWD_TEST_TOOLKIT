...
#to check
download_element_aside= ("xpath", "//li[@data-url='{}']/aside[@class='pack-end']")
download_element_checkbox = ("xpath", "//li[@data-url='{}']/label/input")

#to check
download_entry_info =  ("xpath", "//section[@id='downloadList']/ul/li[contains(@data-url, '{}')]/p[@class='info']")
...
# This assumes there are only 2 buttons in this confirmation frame
download_confirm_yes = ("xpath", "//*[@id='downloadConfirmUI']//menu/button[@class='danger' or @class='recommend']")
