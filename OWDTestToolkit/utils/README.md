# Notes about using 'utils'

This API contains methods which are non-app specific (such as taking an HTML dump of the current frame etc...).<br>
When called, it will set certain defaults on the device:<br>
<br>
<table>
<tr><th align=left>Vibrate                     </th><td align=center>ON                </td></tr>
<tr><th align=left>Volume                      </th><td align=center>OFF (silent)      </td></tr>
<tr><th align=left>Timeout for finding elements</th><td align=center>20 seconds        </td></tr>
<tr><th align=left>Device time                 </th><td align=center>Current local time</td></tr>
</table>
<!--api-->
#UTILS
<table>
...
<tr>
<td align=center>_sb_doToggle</td>
<td align=left>p_def<br>
p_type</td>
<td align=left>  (private) Toggle a button in the statusbar. Don't call this directly, it's used by toggleViaStatusBar(). </td>
</tr>
<tr>
...
<td align=left>p_dom=DOM.Statusbar.status_bar_new<br>
p_displayed=True<br>
p_timeOut=20</td>
...
<td align=left>p_appName<br>
p_reloadHome=True</td>
...
<td align=left>p_tag<br>
p_str<br>
p_quitOnError=True</td>
...
<td align=left>p_element<br>
p_msg<br>
p_displayed=True<br>
p_timeout=_TIMEOUT<br>
p_stop=True</td>
<td align=left>  Waits for an element to be displayed and captures the error if not. </td>
</tr>
<tr>
...
p_timeout=_TIMEOUT<br>
p_stop=True</td>
<td align=left>  Returns a list of matching elements, or False if none are found. </td>
</tr>
<tr>
...
p_timeout=_TIMEOUT<br>
p_stop=True</td>
<td align=left>  Returns an element, or False it it's not found. </td>
</tr>
<tr>
...
<td align=left>p_element_array<br>
p_desc<br>
p_str<br>
...
<tr>
<td align=center>_printSubNote</td>
<td align=left>msgArr</td>
<td align=left>  <i>Private</i> function for reporting. Used by the 'utils' method 'logResult()' - do not call this manually. </td>
</tr>
<tr>
...
p_msg<br>
p_fnam=False</td>
<td align=left>  Add a test result to the result array. Everything after the first "|" is a 'note' line for this message (will be put on a separate line with _subnote prefixed). </td>
</tr>
<tr>
...
<td align=left></td>
<td align=left>  Clear out 'things' left by previous tetss, then Create the final result file from the result and comment arrays (run only once, at the end of each test case). </td>
</tr>
<tr>
