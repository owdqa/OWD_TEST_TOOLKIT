...
class general(object):
    ...
    # def restart_new(self, timeout=120):
    #     self.parent.reporting.logResult('info', 'Restarting the device...')
    #     lock_enabled = self.parent.data_layer.get_setting("lockscreen.enabled")
    #     if lock_enabled:
    #         self.parent.data_layer.set_setting("lockscreen.enabled", False)

    #     self.parent.device.press_sleep_button()
    #     time.sleep(7)
    #     screenshot = self.parent.debug.screenShotOnErr()
    #     self.parent.reporting.logResult('info', "Screenshot", screenshot)

    #     #restart_btn = self.parent.element.getElement(DOM.GLOBAL.sleep_menu_restart, "Restart button")
    #     self.parent.parent.wait_for_element_displayed(*DOM.GLOBAL.sleep_menu_restart)
    #     restart_btn = self.marionette.find_element(*DOM.GLOBAL.sleep_menu_restart)
    #     time.sleep(1)

    #     # Stop
    #     if self.marionette.instance:
    #         self.parent.reporting.logResult('info', 'Close marionette')
    #         # close the gecko instance attached to marionette
    #         self.marionette.instance.close()
    #     elif self.parent.device.is_android_build:
    #         self.parent.reporting.logResult('info', 'clicking restart btn')
    #         #self.parent.device.manager.shellCheckOutput(['stop', 'b2g'])
    #         restart_btn.tap()
    #         #self.parent.element.simulateClick(restart_btn)
    #         self.parent.reporting.logResult('info', 'Waiting for b2g not to run')
    #         Wait(self.marionette, timeout=timeout).until(
    #             lambda m: not self.parent.device.is_b2g_running,
    #             message='b2g failed to stop.')
    #     else:
    #         raise Exception('Unable to stop B2G')
    #     #self.parent.parent.wait_for_condition(lambda m: not self.parent.device.is_b2g_running,
    #     #    message='b2g failed to stop.', timeout=timeout)
    #     # Wait(self.marionette, timeout=timeout).until(
    #         # lambda m: not self.parent.device.is_b2g_running,
    #         # message='b2g failed to stop.')
    #     self.parent.reporting.logResult('info', 'close marionette')
    #     self.marionette.client.close()
    #     self.parent.reporting.logResult('info', 'session = None')
    #     self.marionette.session = None
    #     self.parent.reporting.logResult('info', 'window = None')
    #     self.marionette.window = None

    #     self.parent.reporting.logResult('info', 'Starting again....')
    #     # Start
    #     if self.marionette.instance:
    #         # launch the gecko instance attached to marionette
    #         self.marionette.instance.start()
    #     elif self.parent.device.is_android_build:
    #         self.parent.device.manager.shellCheckOutput(['start', 'b2g'])
    #     else:
